  ...
  <div class="className">
    <el-card class="anoCard">
      ...
      <el-table :data="tableData" border stripe>
        ...
        <el-table-column prop="assignDate" label="指派时间" width="160"></el-table-column>
        <el-table-column prop="customerName" label="客户名称"></el-table-column>
        <!-- <el-table-column prop="telephone" label="手机"></el-table-column>
        <el-table-column prop="implement" label="实施/客服"></el-table-column>
...
import { getDemandJobs } from '@/api/demand'
export default {
  data() {
    return {
      tableData1: [],
